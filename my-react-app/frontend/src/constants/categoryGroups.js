/**
 * 單詞分類表單一資料來源（33 個子分類、36 張分類圖）。
 *
 * 原本 _search/components/CategoryBar.jsx、_camera/result.jsx、_favorite/index.jsx
 * 三個檔案各自逐字重複維護同一份 categoryGroups 常數與全部圖片 import，
 * 新增/調整分類要改三個地方。這裡集中成唯一資料來源，其餘檔案改成從這裡 import。
 */
