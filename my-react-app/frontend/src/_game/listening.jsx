...
const TRIBES = [
  { name: "泰雅", color: "#9B1B30", hasGame: true,  route: "/game/listening/tayal" },
  { name: "阿美", color: "#D4890A", hasGame: true,  route: "/game/listening/amis" },
  { name: "布農", color: "#4E7F63", hasGame: true,  route: "/game/listening/bunun" },
  { name: "噶瑪蘭", color: "#4A7FA5", hasGame: true,  route: "/game/listening/kavalan" },
  { name: "排灣", color: "#6B4FAA", hasGame: true,  route: "/game/listening/paiwan" },
];
  ...
  return (
    <div className="vocab-page">
      <div className="vocab-header">
        ...
        <h1 className="vocab-title">聽力遊戲</h1>
      ...
      {selectedTribe && (
        <div className="vocab-coming-state">
          ...
          <h3 className="vocab-coming-title">{selectedTribe}族語聽力遊戲</h3>
