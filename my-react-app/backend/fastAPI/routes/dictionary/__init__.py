...
- keyed_lock.py：search.py／grammar.py 共用的 _KeyedLock 工具類別
...
schemas/_KeyedLock/warm_cache，維持既有測試（test_dictionary_request_validation.py、
test_keyed_lock.py）原本 `from fastAPI.routes.dictionary import ...` 的匯入路徑不必更動。
"""
